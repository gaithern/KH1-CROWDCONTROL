...
| `message` | Shows viewer-typed free text (truncated to 15 characters) via `kh1.show_custom_item_popup` — the map-prize pickup popup, repurposed to show custom text instead of an item name | Untested end-to-end — switched from `open_text_box`, which wasn't working |
